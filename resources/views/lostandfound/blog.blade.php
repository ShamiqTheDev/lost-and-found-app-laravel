...
@include("lostandfound.search_bar")
    ...
    <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url(public/images/hero_1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
            <img src="public/images/person_1.jpg" alt="Image" class="img-fluid mb-3">
    ...
    <div class="site-section">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6">
            <img src="public/images/hero_2.jpg" alt="Image" class="img-fluid rounded">
          </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6 order-md-2">
            <img src="public/images/hero_1.jpg" alt="Image" class="img-fluid rounded">
          </div>
