...
<div class="container post_adds main_content">
	<h2 class="text-center headings">EDIT POST</h2>
	<div class="row">
		<form action="{{ url('update-submit-post') }}" autocomplete="off" method="post" class="post_form" id="post-form" enctype="multipart/form-data">
			{!! csrf_field() !!}
			<fieldset>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="inputGroupContainer">
								...
								<div class="input-group"><textarea name="description" id="description" placeholder="Enter Description" class="form-control frm-actve" type="text">{!!  str_replace('<br />', "\n", $post->description); !!}</textarea>
								</div>
				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="inputGroupContainer">
								<div class="input-group">
									<input type="text" readonly style="max-width: 75px" class="form-control text-center col-md-2" id="country_code" autocomplete="off" value="+{{ Session::get('country_phonecode') }}" name="country_code"/>
				...
				<div class="form-group submit_btn">
					<div class="input-group">
						<button class="btn same-bg text-white rounded" type="submit" id="post-btn">Update Post</button>
					</div>
				</div> 
			</fieldset>
		</form>
...
<?php $filters = ["state_id", "cat_id", "sub_cat_id","city_id", "make", "model"];
$filter_values = [];
