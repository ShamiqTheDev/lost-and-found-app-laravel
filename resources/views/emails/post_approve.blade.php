          ...
          <tr>
            <td valign="top" class="side title" style="border-collapse: collapse;border: 0;margin: 0;padding: 20px;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 26px;vertical-align: top;background-color: white;border-top: none;">
              <table style="font-weight: normal;border-collapse: collapse;border: 0;margin: 0 auto;padding: 0;font-family: Arial, sans-serif;">
                <!-- <tr>
                  <td class="head-title" style="border-collapse: collapse;border: 0;margin: 0;padding: 0;-webkit-text-size-adjust: none;color: #595959;font-family: Arial, sans-serif;font-size: 28px;line-height: 34px;font-weight: bold; text-align: center;">
                ...
                <tr>
                  <td style="border-collapse:collapse;border:0;margin:0;padding:0;color:#555559;font-family:Arial,sans-serif;font-size:20px;line-height:24px">
                    <div id="m_2840397146577830887download_button" style="text-align:center">
                      <a style="color:#ffffff;background-color:#e33030;border:20px solid #e33030;border-left:20px solid #e33030;border-right:20px solid #e33030;border-top:10px solid #e33030;border-bottom:10px solid #e33030;border-radius:3px;text-decoration:none" href="{{ $post_link }}">VIEW POST</a>
                    </div>
                  </td>
                </tr>
                <tr>
